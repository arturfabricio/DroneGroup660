...
mavic2proHelper.initialiseMotors(robot, 100)
mavic2proHelper.motorsSpeed(robot, TAKEOFF_THRESHOLD_VELOCITY,0, 0,0)
...
targetX, targetY, target_altitude = 1.0, 0.5, 1.0
